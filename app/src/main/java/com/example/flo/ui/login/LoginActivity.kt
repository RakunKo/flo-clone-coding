...
class LoginActivity : AppCompatActivity() , LoginView {
    ...
    private fun login() {
        if (binding.loginIdEt.text.toString().isEmpty() || binding.loginDirectInputEt.toString().isEmpty()) {
        ...
        else Toast.makeText(this, "회원 정보가 존재하지 않습니다.", Toast.LENGTH_SHORT).show()*/
    ...
    override fun onLoginFailure(res: AuthResponse) {
        ...
        binding.loginEmailErrorTv.text = res.message
    }
}